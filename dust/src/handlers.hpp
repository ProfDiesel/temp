...
inline auto make_handlers(auto &&printer) noexcept
{
  ...
  return std::tuple {[printer](const config::parse_error &error, const boost::leaf::e_source_location &location)
                     {
                     ...
                     [printer](const invalid_trigger_config &invalid_trigger_config, const boost::leaf::e_source_location &location)
                     {
                     ...
                     [printer](const missing_field &missing_field, const boost::leaf::e_source_location &location)
                     {
