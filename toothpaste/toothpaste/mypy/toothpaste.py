...
WALKER_TYPE_FULL_NAME = 'ppf.config.walker_kype'
...
class WalkerTransformer:
    ...
    def transform(self) -> None:
        ...
        # validate
        add_method( ctx, 'validate', args=[attr.to_argument() for attr in attributes if attr.is_in_init], return_type=NoneType(),)
