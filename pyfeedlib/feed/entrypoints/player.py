...
async def async_main(argv=None):
    ...
    parser.add_argument('--snapshot-address', type=address, default=Address('127.0.01', 4400))
    parser.add_argument('--update-address', type=address, default=Address('224.0.0.1', 4401))
