...
extern "C" up_state *up_state_new(up_instrument_id_t instrument)
{
  return new up_state {instrument};
}

///////////////////////////////////////////////////////////////////////////////
extern "C" void up_state_free(up_state *self)
{
  delete self;
}

///////////////////////////////////////////////////////////////////////////////
extern "C" void up_state_update_float(up_state *self, int8_t field, float value)
{
  update_state_poly(self->state, static_cast<feed::field>(field), value);
}

///////////////////////////////////////////////////////////////////////////////
extern "C" void up_state_update_uint(up_state *self, int8_t field, uint32_t value)
{
  update_state_poly(self->state, static_cast<feed::field>(field), value);
}
...
///////////////////////////////////////////////////////////////////////////////
extern "C" std::size_t up_encoder_encode(up_encoder *self, up_timestamp_t timestamp, const up_state *states, std::size_t nb_states, void *buffer,
...
///////////////////////////////////////////////////////////////////////////////
extern "C" up_decoder *up_decoder_new() { return new up_decoder{}; }

///////////////////////////////////////////////////////////////////////////////
extern "C" void up_decoder_free(up_decoder *self) { delete self; }

///////////////////////////////////////////////////////////////////////////////
extern "C" std::size_t up_decoder_decode(up_decoder *self, up_timestamp_t timestamp, const up_state *states, std::size_t nb_states, const void *buffer,
                                         std::size_t buffer_size)
{
  return feed::decode([](auto instrument_id, auto sequence_id) { return instrument_id; },
                      [self](auto timestamp, auto update, auto instrument_id) {
                        visit_update([self](auto field, auto value) { 
                      ...
                      network_clock::time_point(std::chrono::nanoseconds(timestamp)),
...
///////////////////////////////////////////////////////////////////////////////
extern "C" void up_server_push_update(up_server *self, const up_state *states, std::size_t nb_states)
{
  std::vector<std::tuple<feed::instrument_id_type, feed::instrument_state>> states_;
  states_.reserve(nb_states);
...
///////////////////////////////////////////////////////////////////////////////
extern "C" void up_server_replay(up_server *self, const void *buffer, std::size_t buffer_size)
{
